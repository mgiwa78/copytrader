...
class SignalProviderController extends Controller
{
     ...
     */
    public function show(SignalProvider $signalProvider)
    {
        //
    }
     ...
     */
    public function update(UpdateSignalProviderRequest $request, SignalProvider $signalProvider)
    {
        //
    }
     ...
     */
    public function destroy(SignalProvider $signalProvider)
    {
        //
    }
}
